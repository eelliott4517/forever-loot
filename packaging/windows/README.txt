...
Dungeon and raid loot tables, profession recipes and a wishlist for WoW: Forever, built from Wowhead's data.
...
USING IT
- Click the minimap button, or type /fl. The tabs are Dungeons, Raids, Professions and Wishlist.
- Click a dungeon or raid on the left to see its bosses and their drops.
...
- Commands: /fl raids (or dungeons, professions, wishlist), /fl gloves (search),
